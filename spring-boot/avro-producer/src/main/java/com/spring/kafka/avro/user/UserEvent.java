...
public class UserEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5747971706452992670L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserEvent\",\"namespace\":\"com.spring.kafka.avro.user\",\"fields\":[{\"name\":\"eventId\",\"type\":\"string\"},{\"name\":\"eventType\",\"type\":\"string\"},{\"name\":\"eventTimestamp\",\"type\":\"long\",\"logicalType\":\"timestamp-micros\"},{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"mobileNumber\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"country\",\"type\":\"string\"},{\"name\":\"createdOn\",\"type\":\"long\",\"logicalType\":\"timestamp-micros\"},{\"name\":\"updatedOn\",\"type\":\"long\",\"logicalType\":\"timestamp-micros\"},{\"name\":\"active\",\"type\":\"boolean\",\"default\":true}]}");
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      ...
      case 12: active = (java.lang.Boolean)value$; break;
      default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.spring.kafka.avro.user.UserEvent.Builder newBuilder() {
    return new com.spring.kafka.avro.user.UserEvent.Builder();
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static com.spring.kafka.avro.user.UserEvent.Builder newBuilder(com.spring.kafka.avro.user.UserEvent.Builder other) {
    if (other == null) {
      return new com.spring.kafka.avro.user.UserEvent.Builder();
    } else {
      return new com.spring.kafka.avro.user.UserEvent.Builder(other);
    }
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static com.spring.kafka.avro.user.UserEvent.Builder newBuilder(com.spring.kafka.avro.user.UserEvent other) {
    if (other == null) {
      return new com.spring.kafka.avro.user.UserEvent.Builder();
    } else {
      return new com.spring.kafka.avro.user.UserEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.spring.kafka.avro.user.UserEvent.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[12], other.active)) {
        this.active = data().deepCopy(fields()[12].schema(), other.active);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.spring.kafka.avro.user.UserEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setEventId(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearEventId() {
      eventId = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setEventType(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearEventType() {
      eventType = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setEventTimestamp(long value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearEventTimestamp() {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setId(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearId() {
      id = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setFirstName(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearFirstName() {
      firstName = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setLastName(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearLastName() {
      lastName = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setEmail(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearEmail() {
      email = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setMobileNumber(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearMobileNumber() {
      mobileNumber = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setCity(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearCity() {
      city = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setCountry(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearCountry() {
      country = null;
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setCreatedOn(long value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearCreatedOn() {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setUpdatedOn(long value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearUpdatedOn() {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder setActive(boolean value) {
     ...
     * @return This builder.
     */
    public com.spring.kafka.avro.user.UserEvent.Builder clearActive() {
    ...
    public UserEvent build() {
      try {
        ...
        record.active = fieldSetFlags()[12] ? this.active : (java.lang.Boolean) defaultValue(fields()[12]);
        return record;
